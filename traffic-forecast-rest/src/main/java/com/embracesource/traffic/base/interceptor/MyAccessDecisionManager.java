...
/**
 * @author ：wangshimin
 * @date ：Created in 2021-01-28 上午 09:10
 * @description：访问决策管理器
 * @version:
 */
@Component
public class MyAccessDecisionManager implements AccessDecisionManager {
    ...
    public void decide(Authentication auth, Object object, Collection<ConfigAttribute> cas) {
        ...
        while (iterator.hasNext()) {
            ...
            for (GrantedAuthority authority : authorities) {
                if (checkAuthority(needRole, authority.getAuthority())) {
                    return;
                }
            }
        }
    ...
    private boolean checkAuthority(String needRole, String authority) {
        ...
        while (authority.endsWith("/*")) {
            ...
            if (needRole.startsWith(authority)) {
                return true;
            }
        }
        return false;
