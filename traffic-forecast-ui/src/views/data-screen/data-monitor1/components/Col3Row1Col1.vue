<template>
  <div id="col3row1col1" class="echarts-wrap" style="width: 100%;height: 100%;" />
</template>
...
export default {
  ...
  methods: {
    loadEcharts(opData) {
      const self = this
      self.myChart = self.echarts.init(document.getElementById('col3row1col1'))
      const option = {
        tooltip: {
          trigger: 'item',
